...
class Properties(wx.Panel):
    def __init__(self, parent):
        ...
        self.vac_api_properties["/"].update(user_metrics)
        ...
        self.vac_api_properties["/"].update(session_metrics)
        ...
        self.vac_api_properties["/"].update(traffic_source_metrics)
        ...
        self.vac_api_properties["/"].update(adwords_metrics)
        ...
        self.vac_api_properties["/"].update(goal_conversions_metrics)
        ...
        self.vac_api_properties["/"].update(platform_device_metrics)
        ...
        self.vac_api_properties["/"].update(geo_network_metrics)
        ...
        self.vac_api_properties["/"].update(system_metrics)
        ...
        self.vac_api_properties["/"].update(social_interaction_metrics)
       ...
       # Create property category for Page Tracking dimensions & metrics
        ...
        self.vac_api_properties["/"].update(page_tracking_metrics)
        ...
        self.vac_api_properties["/"].update(content_grouping_metrics)
        ...
        self.vac_api_properties["/"].update(internal_search_metrics)
        ...
        self.vac_api_properties["/"].update(site_speed_metrics)
        ...
        self.vac_api_properties["/"].update(app_tracking_metrics)
        ...
        self.vac_api_properties["/"].update(event_tracking_metrics)
        ...
        self.vac_api_properties["/"].update(ecommerce_metrics)
        ...
        self.vac_api_properties["/"].update(user_timing_metrics)
        ...
        self.vac_api_properties["/"].update(exception_metrics)
        ...
        self.vac_api_properties["/"].update(content_experiments_metrics)
        ...
        self.vac_api_properties["/"].update(custom_variables_columns_metrics)
        ...
        self.vac_api_properties["/"].update(time_metrics)
        ...
        self.vac_api_properties["/"].update(double_click_campaign_manager_metrics)
        ...
        self.vac_api_properties["/"].update(audience_metrics)
        ...
        self.vac_api_properties["/"].update(adsense_metrics)
        ...
        self.vac_api_properties["/"].update(channel_grouping_metrics)
        ...
        self.vac_api_properties["/"].update(related_products_metrics)
    ...
    def on_property_grid_select(self, event):
        ...
        if current_property:
            try:
                ...
                html_path = self.vac_api_properties["/"][event.GetProperty().GetName()]["html"]
